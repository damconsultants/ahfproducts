...
class MassDeleteSyncData extends Action
{
     ...
     * @param \DamConsultants\Ahfproducts\Model\BynderConfigSyncDataFactory $bynderFactory
     */
    public function __construct(
        Context $context,
        Filter $filter,
        BynderConfigSyncDataCollectionFactory $collectionFactory,
        \DamConsultants\Ahfproducts\Model\BynderConfigSyncDataFactory $bynderFactory
    ) {
        $this->filter = $filter;

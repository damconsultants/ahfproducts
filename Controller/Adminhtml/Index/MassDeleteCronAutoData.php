...
use DamConsultants\Ahfproducts\Model\ResourceModel\Collection\BynderAutoReplaceDataCollectionFactory;
...
class MassDeleteCronAutoData extends Action
{
     ...
     * @param \DamConsultants\Ahfproducts\Model\BynderAutoReplaceDataFactory $bynderFactory
     */
    public function __construct(
        Context $context,
        Filter $filter,
        BynderAutoReplaceDataCollectionFactory $collectionFactory,
        \DamConsultants\Ahfproducts\Model\BynderAutoReplaceDataFactory $bynderFactory
    ) {
        $this->filter = $filter;
    ...
    {
        return $this->_authorization->isAllowed('DamConsultants_Ahfproducts::delete');
    }
}
